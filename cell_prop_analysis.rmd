...
GVEX_matrix = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/gvex_matrix_cpm.csv")
LIBD_matrix = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/libd_matrix_cpm.csv")
CMC_matrix = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/cmc_matrix_cpm.csv")
...
gvex_estimations = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/gvex_cell_prop.csv")
gvex_estimations$dataset = rep("GVEX", nrow(gvex_estimations))
libd_estimations = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/libd_cell_prop.csv")
...
cmc_estimations = read.csv("/external/rprshnas01/kcni/dkiss/KCNI_data_analyses/cmc_cell_prop.csv")
...
significant_mega$vjust = ifelse(significant_mega$estimate >= 0, -2, 2.5)
