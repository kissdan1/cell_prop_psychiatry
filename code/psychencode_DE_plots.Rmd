...
Gprofiler: Take list of uncorrected pvals from a cell type (PVALB?) and run genes through grprofiler -> ranked whole list by logFC and unranked/pval thresholded
