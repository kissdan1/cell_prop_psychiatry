...
all_estimations = read_csv( "/external/rprshnas01/kcni/dkiss/cell_prop_psychiatry/data/psychencode_mgp_estimations.csv")
all_estimations$newStudy = all_estimations$newStudy %>% factor(levels = c("GVEX", "NIMH_HBCC","Pitt", "LIBD_szControl", "MSSM", "Penn"))
all_estimations = all_estimations %>% filter(ageDeath >= 15)
...
mean_ageDeath = all_estimations_long %>%
  ...
  mutate(Cohort = factor(Cohort, levels = c("GVEX", "NIMH_HBCC","Pitt", "LIBD_szControl", "MSSM", "Penn"))) %>%
